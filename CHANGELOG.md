...
### Fixed
- Align `NOTICES.md` and `AgeSignalsBuildValidator.cs` to the pinned `age-signals:0.0.3` SDK version (both still named the older `0.0.2`). No runtime change; corrects the legal attribution and the EDM4U build-warning text.
